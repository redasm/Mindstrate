...
export const initializeScanSourceSchema = (db: Database.Database): void => {
  db.exec(`
    ...
    CREATE INDEX IF NOT EXISTS idx_scan_sources_enabled ON scan_sources(enabled, last_run_at);
