...
> Git / P4 / Hook 数据源采集已经外移到独立工具 `mindstrate-scan`。框架本身只提供知识与事件注入接口；数据源发现、定时扫描、hook 触发都由外部工具负责。详见 [packages/repo-scanner/README.md](./packages/repo-scanner/README.md)。
